...
Scenario: Verify User clicks on {string} link to access registration page
...
Scenario: Verify User successfully registers with letters as username and other valid fields
    ...
    Then User should see a success message "You are logged in" on the page 
...
Scenario: Verify User successfully registers with @/./+/-/_ as username and other valid fields
    ...
    | testuser112@gmail.com   | Test@1234  | Test@1234       |
...
Scenario: Verify Username with space and other valid input fields
    ...
    Then User should see error message "password_mismatch:The two password fields didn’t match." 
...
Scenario: Verify user enters Password exactly 8 characters
    Given User on Registration page
    When User enters valid username,Password ,Password Confirmation of exact 8 characters and clicks on Register button
    Then User should be able to register 

Scenario: Verify user enters Password  lessthan 8 characters
    Given User on Registration page
...
Scenario: Verify user returns to login page from the register page
    Given User on Registration page
