...
public class DatastructuresPages {
	...
	@FindBy(tagName = "h4")
	private WebElement fetchingheading;
	...
	/*
	 * @FindBy(id = "dropdownMenuButton") WebElement dropdownButton;
	 */
	...
	public void openDataPage() {
		...
		String dsIntroPath = ConfigReader.get("dsintro.url");
	...
	public boolean isTimeComplexityHeadingDisplayed() {
		try {
			...
			WebElement element = wait.until(
					ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[contains(text(),'Time Complexity')]")));
			return element.isDisplayed();
		} catch (Exception e) {
			System.out.println("Time Complexity content not visible: " + e.getMessage());
			return false;
			/*
			 * try { // wait.until(ExpectedConditions.urlContains("/time-complexity"));
			 * wait.until(ExpectedConditions.visibilityOf(timecomplexityheading)); return
			 * timecomplexityheading.isDisplayed(); } catch (Exception e) {
			 * System.out.println("ERROR: Time Complexity heading not visible: " +
	...
	public void clickRunButton() {
		try {
			...
			wait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(runButton))).click();
		} catch (Exception e) {
	...
	public void enterInvalidPythonCode(String fetchinvalidcode) {
		...
		((JavascriptExecutor) driver).executeScript(
				"document.querySelector('.CodeMirror').CodeMirror.setValue(arguments[0]);", fetchinvalidcode);
	}

	/*
	 * public void enterValidPythonCode(String code) { ((JavascriptExecutor)
	...
	/*
	 * public void clickPracticeQuestionslink() { // WebDriverWait wait = new
	 * WebDriverWait(driver, Duration.ofSeconds(10));
	 * wait.until(ExpectedConditions.elementToBeClickable(practicequestions)).click(
	 * );
	 * 
	 * } /*public boolean isPracticequestionsVisible() { WebDriverWait wait = new
	 * WebDriverWait(driver, Duration.ofSeconds(10)); try { return
	 * wait.until(ExpectedConditions.visibilityOf(practicequestions)).isDisplayed();
	...
	public void selectDropdownOption(String moduleName) {
		...
		List<WebElement> items = wait.until(ExpectedConditions
				.presenceOfAllElementsLocatedBy(By.cssSelector("div.dropdown-menu.show a.dropdown-item")));
	...
	public String getDsIntroSectionName() {
		return "Data Structures-Introduction";
	}

	public String getDsIntroHeading() {
		return "Data Structures-Introduction";
	}

	public String getTopicsCoveredHeading() {
		return "Topics Covered";
	}

	public String getTimeComplexityLinkText() {
		return "Time Complexity";
	}

	public String getTimeComplexityHeading() {
		return "Time Complexity";
	}

	public String getTryHereButtonText() {
		return "Try here";
	}
	...
	public String getTryEditorName() {
		return "tryEditor";
	}

	public String getDefaultValidCode() {
