...
public class LoginPage {
	...
	public void selectModule(String module) {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement moduleLink = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='" + module + "']")));
	...
	public void userclicksregisterlink() {
		new WebDriverWait(driver, Duration.ofSeconds(10)).until(ExpectedConditions.elementToBeClickable(registerlink))
				.click();
	}
	...
	public boolean isSigninLinkVisible() {
		try {
			...
			// ((JavascriptExecutor)
			// driver).executeScript("arguments[0].scrollIntoView(true);", signinlink);
			// WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
			// wait.until(ExpectedConditions.visibilityOf(registerlink));
			// return registerlink.isDisplayed();
			new WebDriverWait(driver, Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOf(signinlink));
