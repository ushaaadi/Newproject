...
public class Datastructuresnavigation {
	 ...
	 * 
	 * @When("User selects {string} from the Data Structures dropdown") public void
	 * user_selects_module_from_dropdown(String moduleName) {
	 * datastructures.clickDropdown();
	 * datastructures.selectDropdownOption(moduleName); }
	 * 
	 * @Then("User should be navigated to the {string} module page") public void
	 * user_should_be_navigated_to_the_module_page(String expectedPath) { String
	 * currentUrl = driver.getCurrentUrl(); System.out.println("Current URL: " +
	 * currentUrl); Assert.assertTrue(currentUrl.contains(expectedPath),
	 * "Expected URL to contain: " + expectedPath + ", but got: " + currentUrl); }
	 * 
	 * @When("User clicks on Data Structures dropdown") public void
	 * user_clicks_on_data_structures_dropdown() { datastructures.clickDropdown(); }
	 */// Commented By Usha
